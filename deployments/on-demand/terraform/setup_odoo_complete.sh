...
# 2. CREAR CONFIGURACIÓN NGINX INICIAL
echo "=========================================="
...
echo "=========================================="
echo "=== 3. CREANDO VARIABLES DE ENTORNO ==="
echo "=========================================="
cat > .env << EOF
...
echo "=========================================="
echo "=== 5. OBTENIENDO CERTIFICADO LET'S ENCRYPT ==="
echo "=========================================="
